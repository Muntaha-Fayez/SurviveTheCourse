...
const courses = [
  { name: 'Data Algorithms and Structure', code: 'CS201', progress: 78, color: 'violet', chapter: 'Graph Algorithms', icon: Code2 },
  { name: 'Computer Network', code: 'CS301', progress: 64, color: 'blue', chapter: 'Routing & Protocols', icon: Brain },
  { name: 'Probability', code: 'MA201', progress: 48, color: 'orange', chapter: 'Random Variables', icon: Archive },
  { name: 'C++', code: 'CS102', progress: 36, color: 'green', chapter: 'Object-Oriented Programming', icon: GraduationCap },
]
...
export default function Page() {
  ...
  function showAnnouncement(message: string) {
    ...
    window.setTimeout(() => setAnnouncement(''), 2200)
  }
  ...
  return (
    <main className="min-h-screen bg-[#0c0d14] text-slate-200 selection:bg-indigo-500/30">
      ...
      {announcement && <div role="status" className="fixed bottom-6 left-1/2 z-[60] -translate-x-1/2 rounded-lg border border-indigo-400/20 bg-[#181925] px-4 py-3 text-xs font-medium text-indigo-200 shadow-2xl shadow-black/40">{announcement}</div>}
